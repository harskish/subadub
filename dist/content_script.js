...
(function initializeSubadub() {
  ...
  function renderAndReconcile() {
    ...
    function addTrackElem(videoElem, blob, srclang) {
      ...
      customSubsElem.style.cssText = 'position: absolute; bottom: 10vh; left: 0; right: 0; color: white; font-size: 2vw; text-align: center; user-select: text; -moz-user-select: text; z-index: 100; pointer-events: none';
